public class surprise extends emotion {
    ...
    public surprise(String antecedentConditionName){
        super(antecedentConditionName, Recommended.DEFAULT_COUNT, Recommended.DEFAULT_RECOMMENDED_NEEDVALUE);
    }
    public surprise(String antecedentConditionName, int count, int npd){
